...
Before creating any commit or pushing, determine and run every relevant project quality check that should pass for the current changes. Inspect the project's GitHub workflows plus `composer.json` and `package.json` to identify the authoritative commands. Include all relevant categories:
